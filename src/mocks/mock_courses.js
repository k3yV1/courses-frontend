export const mockCourses = [
	{
		...
		content: [
			{
				id: 1,
				title: '<span class="md:text-2xl text-base font-bold">Front-end developer</span>',
				subtitle: '<span class="opacity-40 text-base">5+ months * For beginners</span>',
				description: '<span class="text-base">A Frontend developer is responsible for creating a convenient and aesthetic appearance of a web page on different devices, and also implements animations and other interface solutions.</span>',
			},
		],
		lessons: [
			{
				id: 1,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 1 - Front-end developer</span>',
				content: `
          ...
          <p class="text-base mt-3">Nulla pharetra diam sit amet nisl suscipit adipiscing bibendum. Facilisis volutpat est velit egestas dui. Enim diam vulputate ut pharetra sit amet aliquam id diam. Sagittis orci a scelerisque purus semper eget duis at. Phasellus faucibus scelerisque eleifend donec pretium. Pharetra convallis posuere morbi leo urna molestie at elementum eu. Purus gravida quis blandit turpis cursus in hac habitasse platea. At elementum eu facilisis sed odio. Dis parturient montes nascetur ridiculus mus mauris. Bibendum at varius vel pharetra vel turpis nunc. Feugiat pretium nibh ipsum consequat. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis.</p>`,
			...
			{
				id: 2,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 2 - Front-end developer</span>',
				content: `
				<p class="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in nisl nisi scelerisque. Tortor pretium viverra suspendisse potenti nullam ac tortor. Lectus mauris ultrices eros in cursus turpis. Vestibulum sed arcu non odio euismod lacinia. Porta non pulvinar neque laoreet suspendisse interdum consectetur. Neque volutpat ac tincidunt vitae semper. Sit amet mauris commodo quis imperdiet massa tincidunt nunc. In metus vulputate eu scelerisque felis imperdiet proin. Tortor consequat id porta nibh. Turpis egestas maecenas pharetra convallis posuere morbi. Enim sit amet venenatis urna.</p>
	...
	},
	{
		...
		content: [
			{
				id: 2,
				title: '<span class="md:text-2xl text-base font-bold">Full-stack developer</span>',
				subtitle: '<span class="opacity-40 text-base">5+ months * For beginners</span>',
				description: '<span class="text-base">Fullstack developers have both front-end (client-side) and back-end (server-side) programming skills. They are able to develop a complete product from start to finish.</span>',
			}
		],
		lessons: [
			{
				id: 3,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 1 - Full-stack developer</span>',
				content: `
				<p class="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in nisl nisi scelerisque. Tortor pretium viverra suspendisse potenti nullam ac tortor. Lectus mauris ultrices eros in cursus turpis. Vestibulum sed arcu non odio euismod lacinia. Porta non pulvinar neque laoreet suspendisse interdum consectetur. Neque volutpat ac tincidunt vitae semper. Sit amet mauris commodo quis imperdiet massa tincidunt nunc. In metus vulputate eu scelerisque felis imperdiet proin. Tortor consequat id porta nibh. Turpis egestas maecenas pharetra convallis posuere morbi. Enim sit amet venenatis urna.</p>
          ...
          <p class="text-base mt-3">Nulla pharetra diam sit amet nisl suscipit adipiscing bibendum. Facilisis volutpat est velit egestas dui. Enim diam vulputate ut pharetra sit amet aliquam id diam. Sagittis orci a scelerisque purus semper eget duis at. Phasellus faucibus scelerisque eleifend donec pretium. Pharetra convallis posuere morbi leo urna molestie at elementum eu. Purus gravida quis blandit turpis cursus in hac habitasse platea. At elementum eu facilisis sed odio. Dis parturient montes nascetur ridiculus mus mauris. Bibendum at varius vel pharetra vel turpis nunc. Feugiat pretium nibh ipsum consequat. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis.</p>`,
			...
			{
				id: 4,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 2 - Full-stack developer</span>',
				content: `
				<p class="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in nisl nisi scelerisque. Tortor pretium viverra suspendisse potenti nullam ac tortor. Lectus mauris ultrices eros in cursus turpis. Vestibulum sed arcu non odio euismod lacinia. Porta non pulvinar neque laoreet suspendisse interdum consectetur. Neque volutpat ac tincidunt vitae semper. Sit amet mauris commodo quis imperdiet massa tincidunt nunc. In metus vulputate eu scelerisque felis imperdiet proin. Tortor consequat id porta nibh. Turpis egestas maecenas pharetra convallis posuere morbi. Enim sit amet venenatis urna.</p>
	...
	},
	{
		...
		content: [
			{
				id: 3,
				title: '<span class="md:text-2xl text-base font-bold">Python developer</span>',
				subtitle: '<span class="opacity-40 text-base">3+ months * For beginners</span>',
				description: '<span class="text-base">Python developers can work in a variety of fields, from machine learning to web development. They have the knowledge needed to create, extend, and maintain programs that use Python as their primary programming language.</span>',
			}
		],
		lessons: [
			{
				id: 5,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 1 - Python developer</span>',
				content: `
				<p class="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in nisl nisi scelerisque. Tortor pretium viverra suspendisse potenti nullam ac tortor. Lectus mauris ultrices eros in cursus turpis. Vestibulum sed arcu non odio euismod lacinia. Porta non pulvinar neque laoreet suspendisse interdum consectetur. Neque volutpat ac tincidunt vitae semper. Sit amet mauris commodo quis imperdiet massa tincidunt nunc. In metus vulputate eu scelerisque felis imperdiet proin. Tortor consequat id porta nibh. Turpis egestas maecenas pharetra convallis posuere morbi. Enim sit amet venenatis urna.</p>
          ...
          <p class="text-base mt-3">Nulla pharetra diam sit amet nisl suscipit adipiscing bibendum. Facilisis volutpat est velit egestas dui. Enim diam vulputate ut pharetra sit amet aliquam id diam. Sagittis orci a scelerisque purus semper eget duis at. Phasellus faucibus scelerisque eleifend donec pretium. Pharetra convallis posuere morbi leo urna molestie at elementum eu. Purus gravida quis blandit turpis cursus in hac habitasse platea. At elementum eu facilisis sed odio. Dis parturient montes nascetur ridiculus mus mauris. Bibendum at varius vel pharetra vel turpis nunc. Feugiat pretium nibh ipsum consequat. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis.</p>`,
			...
			{
				id: 6,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 2 - Python developer</span>',
				content: `
				<p class="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in nisl nisi scelerisque. Tortor pretium viverra suspendisse potenti nullam ac tortor. Lectus mauris ultrices eros in cursus turpis. Vestibulum sed arcu non odio euismod lacinia. Porta non pulvinar neque laoreet suspendisse interdum consectetur. Neque volutpat ac tincidunt vitae semper. Sit amet mauris commodo quis imperdiet massa tincidunt nunc. In metus vulputate eu scelerisque felis imperdiet proin. Tortor consequat id porta nibh. Turpis egestas maecenas pharetra convallis posuere morbi. Enim sit amet venenatis urna.</p>
	...
	},
	{
		...
		content: [
			{
				id: 4,
				title: '<span class="md:text-2xl text-base font-bold">Junior Python developer</span>',
				subtitle: '<span class="opacity-40 text-base">3+ months * For beginners</span>',
				description: '<span class="text-base">Python developers can work in a variety of fields, from machine learning to web development. They have the knowledge needed to create, extend, and maintain programs that use Python as their primary programming language.</span>',
			}
		],
		lessons: [
			{
				id: 6,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 1 - Junior Python developer</span>',
				content: `
				<p class="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in nisl nisi scelerisque. Tortor pretium viverra suspendisse potenti nullam ac tortor. Lectus mauris ultrices eros in cursus turpis. Vestibulum sed arcu non odio euismod lacinia. Porta non pulvinar neque laoreet suspendisse interdum consectetur. Neque volutpat ac tincidunt vitae semper. Sit amet mauris commodo quis imperdiet massa tincidunt nunc. In metus vulputate eu scelerisque felis imperdiet proin. Tortor consequat id porta nibh. Turpis egestas maecenas pharetra convallis posuere morbi. Enim sit amet venenatis urna.</p>
          ...
          <p class="text-base mt-3">Nulla pharetra diam sit amet nisl suscipit adipiscing bibendum. Facilisis volutpat est velit egestas dui. Enim diam vulputate ut pharetra sit amet aliquam id diam. Sagittis orci a scelerisque purus semper eget duis at. Phasellus faucibus scelerisque eleifend donec pretium. Pharetra convallis posuere morbi leo urna molestie at elementum eu. Purus gravida quis blandit turpis cursus in hac habitasse platea. At elementum eu facilisis sed odio. Dis parturient montes nascetur ridiculus mus mauris. Bibendum at varius vel pharetra vel turpis nunc. Feugiat pretium nibh ipsum consequat. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis.</p>`,
			...
			{
				id: 7,
				title: '<span class="md:text-2xl text-base font-bold">Lesson 2 - Junior Python developer</span>',
				content: `
				<p class="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in nisl nisi scelerisque. Tortor pretium viverra suspendisse potenti nullam ac tortor. Lectus mauris ultrices eros in cursus turpis. Vestibulum sed arcu non odio euismod lacinia. Porta non pulvinar neque laoreet suspendisse interdum consectetur. Neque volutpat ac tincidunt vitae semper. Sit amet mauris commodo quis imperdiet massa tincidunt nunc. In metus vulputate eu scelerisque felis imperdiet proin. Tortor consequat id porta nibh. Turpis egestas maecenas pharetra convallis posuere morbi. Enim sit amet venenatis urna.</p>
